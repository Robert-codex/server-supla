    ...
    public function getConfigTreeBuilder() {
        ...
        $rootNode = $treeBuilder->getRootNode()
            ->children()
                ...
                ->arrayNode('account_limits')->addDefaultsIfNotSet()->children()
                    ->booleanNode('self_update_enabled')->defaultFalse()
                        ->info('Allow authenticated users to update their own account limits from the GUI.')->end()
                ->end()->end()
