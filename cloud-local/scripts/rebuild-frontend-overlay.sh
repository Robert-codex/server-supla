...
entry_local="${dist_dir}/index-DfO4cloU-limitsfix-loginfix.js"
entry_legacy="${dist_dir}/index-DfO4cloU.js"

login_page_base="${dist_dir}/login-page-CfxWV-Jq.js"
login_page_local="${dist_dir}/login-page-CfxWV-Jq-loginfix.js"

login_form_base="${dist_dir}/login-form-C8Lf4buW.js"
login_form_local="${dist_dir}/login-form-C8Lf4buW-loginfix.js"

resend_base="${dist_dir}/resend-account-activation-link-DP8hDyU_.js"
resend_local="${dist_dir}/resend-account-activation-link-DP8hDyU_-loginfix.js"

cp "${resend_base}" "${resend_local}"
perl -0pi -e \
  's#\./index-DfO4cloU-limitsfix\.js#./index-DfO4cloU-limitsfix-loginfix.js#g' \
  "${resend_local}"

cp "${login_form_base}" "${login_form_local}"
perl -0pi -e \
  's#\./index-DfO4cloU-limitsfix\.js#./index-DfO4cloU-limitsfix-loginfix.js#g; s#\./resend-account-activation-link-DP8hDyU_\.js#./resend-account-activation-link-DP8hDyU_-loginfix.js#g' \
  "${login_form_local}"

cp "${login_page_base}" "${login_page_local}"
perl -0pi -e \
  's#\./login-form-C8Lf4buW\.js#./login-form-C8Lf4buW-loginfix.js#g; s#\./index-DfO4cloU-limitsfix\.js#./index-DfO4cloU-limitsfix-loginfix.js#g; s#\./resend-account-activation-link-DP8hDyU_\.js#./resend-account-activation-link-DP8hDyU_-loginfix.js#g' \
  "${login_page_local}"

cp "${entry_source}" "${entry_local}"
perl -0pi -e \
  's#dist/login-page-CfxWV-Jq\.js#dist/login-page-CfxWV-Jq-loginfix.js#g; s#\./login-page-CfxWV-Jq\.js#./login-page-CfxWV-Jq-loginfix.js#g; s#dist/login-form-C8Lf4buW\.js#dist/login-form-C8Lf4buW-loginfix.js#g; s#dist/resend-account-activation-link-DP8hDyU_\.js#dist/resend-account-activation-link-DP8hDyU_-loginfix.js#g' \
  "${entry_local}"
perl -0pi -e \
...
cat > "${entry_base}" <<'EOF'
import "./index-DfO4cloU-limitsfix-loginfix.js";
export * from "./index-DfO4cloU-limitsfix-loginfix.js";
EOF
