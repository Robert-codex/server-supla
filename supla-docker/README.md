...
Detailed Linux installation instructions from a fresh GitHub checkout are available in [docs/installation-from-github.md](docs/installation-from-github.md).
...
If you want to run your own MQTT broker next to SUPLA, use the overlay files:

- `docker-compose.mqtt.yml`
- `docker-compose.mqtt-tls.yml`
- `docker-compose.mqtt-db-auth.yml`
